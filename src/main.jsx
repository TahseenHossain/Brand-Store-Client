    ...
    children: [
      {
        path: "/",
        element: <Home></Home>,
        //loader: () => fetch("https://brand-store-server-lovat.vercel.app/user"),
      },
      {
        path: "/Cars/:brand",
        element: (
        ...
        loader: () => fetch("https://brand-store-server-lovat.vercel.app/elements"),
      },
      {
        path: "/detail/:model",
        element: (
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://brand-store-server-lovat.vercel.app/elements/${params.id}`),
      },
      {
        path: "/LogIn",
        element: <LogIn></LogIn>,
